...
I'm an ML Engineer at **MBank**, one of Kyrgyzstan's leading digital banks, where I develop machine learning models that support financial decisions for real customers.

- 🏦 **Production ML:** income prediction (Model 2 of a credit potential prediction pipeline), loan overdue prediction (end-to-end), and a recommendation system.
